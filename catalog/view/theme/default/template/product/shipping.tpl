...
$('#button-quote').on('click', function() {
    ...
    var $product = getUrlParameter('product_id');

    //var $product = getUrlVars()["product_id"];
    //window.alert(window.location.href);
	$.ajax({
		url: 'index.php?route=product/shipping/quote',
		type: 'post',
		data: 'product_id=' + $product + '&country_id=' + $('select[name=\'country_id\']').val() + '&zone_id=' + $('select[name=\'zone_id\']').val() + '&postcode=' + encodeURIComponent($('input[name=\'postcode\']').val()),
		dataType: 'json',
		beforeSend: function() {
...
*/
                ...
                //html += '<?php echo $rate; ?>';
                //html += '<?php echo $_SERVER['REQUEST_URI']; ?>';
            /*
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		url: 'index.php?route=product/shipping/shipping',
		type: 'post',
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=product/shipping/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
