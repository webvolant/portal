              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                        ...
                        <?php if ($layout_module['position'] == 'content_pay') { ?>
                        <option value="content_pay" selected="selected"><?php echo "content_pay"; ?></option>
                        <?php } else { ?>
                        <option value="content_pay"><?php echo "content_pay"; ?></option>
                        <?php } ?>
...
function addModule() {
    ...
    html += '    <option value="content_pay"><?php echo "content_pay"; ?></option>';
    html += '  </select></td>';
